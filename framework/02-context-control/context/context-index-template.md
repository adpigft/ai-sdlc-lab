...
| --- | --- | --- |
| Workflow state | framework/01-lifecycle/workflow/workflow-state-guide.md | Current state behavior |
| Review flow | framework/01-lifecycle/workflows/review-approval-flow.md | Status/Review/Approved |
| Placement | framework/03-delivery-governance/service-architecture/implementation-placement-model.md | Required before implementation |
