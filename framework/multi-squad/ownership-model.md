...
- `framework/frontend/app-catalog-template.md` for frontend apps
- `framework/service-architecture/service-catalog-template.md` for services
- `framework/libraries/library-catalog-template.md` for shared libraries
- `framework/events/event-catalog-template.md` for events
