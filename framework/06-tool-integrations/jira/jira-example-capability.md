...
This is an example operating model. The source-of-truth business artifacts remain under `domains/payments/capabilities/payment-refund/features/qr-refund/` and `traceability/`.
...
| Epic Name | QR Refund |
| Domain | Payments |
| Feature Folder | `domains/payments/capabilities/payment-refund/features/qr-refund/` |
...
| Implementation Plan | `domains/payments/capabilities/payment-refund/features/qr-refund/implementation/implementation-plan.md` |
| Validation Plan | `domains/payments/capabilities/payment-refund/features/qr-refund/validation/validation-plan.md` |
...
| Git Artifact | `domains/payments/capabilities/payment-refund/features/qr-refund/design/design.md` |
...
| --- | --- | --- | --- |
| `DEF-QRREF-001` | Duplicate Refund Created Under Concurrency | RCA using `framework/07-templates/defect-rca-template.md` | `VAL-QRREF-CONC-001` |
...
| --- | --- |
| Validation Plan | `domains/payments/capabilities/payment-refund/features/qr-refund/validation/validation-plan.md` |
| Validation Report | `domains/payments/capabilities/payment-refund/features/qr-refund/validation/validation-report.md` when produced |
...
| Release Notes | `domains/payments/capabilities/payment-refund/features/qr-refund/release/release-notes.md` |
