...
- Capability context and feature artifacts are authoritative for capability-specific and feature-specific content.
...
| --- | --- | --- | --- |
| `<capability>` | `domains/<domain>/capabilities/<capability>/features/<feature>/` | `domains/<domain>/capabilities/<capability>/features/<feature>/workflow-state.yaml` | `<notes>` |
...
This file should be generated or validated in the future from domain context, capability context, feature artifacts, workflow state, and catalogs.
