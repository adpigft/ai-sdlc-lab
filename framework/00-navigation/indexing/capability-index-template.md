...
- Capability context and feature artifacts are authoritative for their own content.
...
| Feature path | `domains/<domain>/capabilities/<capability>/features/<feature>/` |
| Workflow state | `domains/<domain>/capabilities/<capability>/features/<feature>/workflow-state.yaml` |
...
| Implementation Plan | `implementation-plan.md` | `implementation/implementation-plan.md` | `workflow-state.yaml` |
| PR Review | `pr-review-report.md` | `pr-review/pr-review-report.md` | `workflow-state.yaml` |
