...
| `requirements_review` | Requirements is being drafted or reviewed for approval. | `requirements` |
...
Transition: intent_review -> requirements_review.
...
The workflow-state file should be stored in Git beside the feature artifacts when adopted. Jira may mirror the state for work management, but Git remains the source of truth for lifecycle state history.
