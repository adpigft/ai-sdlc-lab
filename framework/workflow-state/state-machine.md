...
| --- | --- | --- |
| `idea` | Raw capability idea or intake exists. | `new` |
...
| `architecture_review` | Architecture, API considerations, decisions, and implementation planning are being drafted or reviewed. | `architecture` |
